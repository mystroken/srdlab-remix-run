...
export const publications: PublicationType[] = [
  ...
  },
  {
    ...
    image: PUB1,
    date: "Kinshasa, RDC",
    delay: "01 au 03 Fév 2023",
    title:
      "Atelier de lancement de l’étude sur le commerce illicite de cigarettes en RDC",
    header:
    ...
    content1:
      "Cette initiative vise à agréger et faciliter l'accès aux données nécessaires à la conception et à la mise en œuvre des politiques antitabac effectuées par les gouvernements en Afrique Subsaharienne. TCDI est mis en œuvre par l'organisation internationale à but non lucratif Development Gateway, en partenariat avec l'Université du Cap, grâce au financement de la Fondation Bill et Melinda Gates.",
    content2:
      "La recherche proposée devrait aborder les principales questions suivantes :",
    content3:
      "Du 01 au 03 février 2023, SRD Lab a donc participé à l'atelier de lancement de l'étude sur le commerce illicite des cigarettes en RDC. L'objectif était de discuter et de valider la méthodologie, les livrables attendus et le calendrier prévu de l'étude. Nous vous donnons rendez-vous dans quelques semaines pour les nouvelles au sujet de cette étude, dont la pertinence est indiscutable.",
    content4: [
      "1. Quel est le pourcentage du commerce illicite de la cigarette en RDC ?",
      "2. quelles sont les origines et les marques des cigarettes illicites vendues en rdc ?",
    ],
  },
  {
    slug: "3",
    ...
    delay: "11 Août 2023",
    title:
      "Restitution des Résultats de l'Étude sur le Commerce Illicite de Cigarettes en RDC",
    header:
  ...
  },
  {
    ...
    content2:
      "La recherche proposée devrait aborder les principales questions suivantes : ",
    content4: [
      "1. Quelle est la prévalence du tabagisme chez les adolescents de 10 à 17 ans dans les pays ciblés ?",
      "2. Quels sont les facteurs multi niveaux (p. ex., individuels, domestiques et environnementaux) associés à toutes les formes de tabagisme chez les adolescents (p. ex., tabagisme et tabac sans fumée) dans chaque pays ?",
    ],
    content3:
