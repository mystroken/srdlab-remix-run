...
export const carouselItems: SolutionsType[] = [
    ...
    },
    {
        ...
        content: "SRDLab est une équipe d'experts qui mettent leurs compétences et expériences  au service des clients afin de les satisfaire et même dépasser leurs attentes."
    },
    {
        title: "Nous maîtrisons le terrain",
        content: "C'est sur le terrain, confrontés aux réalités et aux difficultés, que nous avons consolidé notre savoir-faire"
    },
