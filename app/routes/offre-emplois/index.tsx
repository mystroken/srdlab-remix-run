      ...
      <DefaultLayout>
        ...
        <div className="container mx-auto">
          <div className="py-16 md:py-44">
            <div
              className={
                "flex mt-20 md:mt-0 flex-row justify-center items-center space-x-8 text-sm font-normal"
              }
            >
              <div
                onClick={selectAll}
              ...
              <div
                className={`${
                  openFerme
                    ? "bg-red-500 text-white rounded-full text-xs px-4 py-2"
                    : ""
                } cursor-pointer`}
                onClick={selectFerme}
              >
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 container pt-10 gap-y-4  md:gap-x-10">
              {openAll &&
                postes.map((item: PosteType, index: number) => {
                  return (
                    <Post
                      key={index}
                      open={item.open}
