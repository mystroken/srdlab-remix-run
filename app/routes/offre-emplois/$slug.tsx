              ...
              <div className="flex flex-row mt-16 md:mt-0">
                <div className="w-full lg:w-3/4">
                  ...
                  <p className="mb-6 text-xs text-gray-600">
                    ...
                    {myposte.date}
                    <div className={`my-4`}>
                      <p className="leading-8 font-semibold text-base md:text-justify">
                        Contexte
                      </p>
                      <p className="leading-8 font-normal text-justify">
                        {myposte.context}
                      </p>
                    </div>
                    <div className={`my-4`}>
                    ...
                    <div className={`my-4`}>
                      <p className="leading-8 font-semibold text-base text-justify">
