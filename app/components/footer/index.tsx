...
export default function FooterComponent() {
  ...
  return (
    <footer className="bg-primary pt-10">
      <div className="container mx-auto py-10">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:1/4 my-6 md:my-0 text-center md:text-start">
            <div className="flex flex-col justify-center items-center md:items-start text-center text-xl md:text-start">
      ...
      {contact && (
        <Modal onClose={() => setContact(!contact)} title="Contact">
          <ContactForm onClose={() => setContact(!contact)} />
        </Modal>
      )}
    </footer>
  );
