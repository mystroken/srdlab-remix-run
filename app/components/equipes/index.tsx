                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-y-4">
                  {equipes.map((item: EquipeType, index) => (
                    <div
                      ...
                      className="h-32 md:mb-6 md:w-11/12 "
                    >
                      <div className="p-4 border border-gray-400 hover:border-2 cursor-pointer flex items-start flex-col justify-center rounded-md h-full">
                        <h2 className="md:w-[14rem] xl:w-[18rem] text-[1.2rem] text-primary">
                          {item.name}
                        </h2>
                        <h2 className="text-sm mt-2 font-normal leading-[130%] text-primary">
                          {item.title}
                        </h2>
                      </div>
                    </div>
            ...
            <div className="flex flex-row items-center">
              ...
              <div>
                ...
                <p className="text-xs font-normal ml-4">
                  {equipes[myIndex].title}
                </p>
              </div>
            </div>
            <hr className="my-2" />
            <p className="text-xs leading-6 py-1 overflow-y-scroll md:overflow-hidden h-[280px] md:h-64">
              {equipes[myIndex].description}
            </p>
            <hr className="my-2" />
            <a
              href={`mailto:${equipes[myIndex].mail}`}
              className="text-xs font-normal cursor-pointer pt-4 hover:underline hover:underline-offset-4"
            >
              {equipes[myIndex].mail}
            </a>
          </div>
        </Modal>
      )}
...
export default EquipesComponent;
