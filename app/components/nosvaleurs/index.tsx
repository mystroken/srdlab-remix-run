                                        ...
                                        valeurs.map((item, index) => {
                                            return (
                                                <div
                                                    ...
                                                    <p className={`${showText === false ? 'flex' : 'hidden'} pt-[1.3rem] text-[0.7rem] text-white leading-[185%]`}>{cleanText(item.content, 200)}</p>
                                                    <p className={`${showText === true ? 'flex' : 'hidden'} pt-[1.3rem] text-[0.7rem] text-white leading-[185%]`}>{item.content}</p>
                                                </div>
                                            )
                                        })
                                    }
